...
def first_generation_calibration(myms,
    ...
    write_casa_scripts.write_gaincal(myms, G0_table, flux_cal, '3', 'p', 'inf', script_name, outdir)
    ...
    write_casa_scripts.write_gaincal(myms, G1_table, flux_cal, '3', 'p', 'inf', script_name, outdir, gaintable=[G0_table,B0_table,K0_table])
    write_casa_scripts.write_gaincal(myms, G1_table, phase_cal, '3', 'p', 'inf', script_name, outdir, gaintable=[G0_table,B0_table,K0_table], append='True')
